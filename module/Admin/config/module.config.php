...
return array(
    ...
    'controllers' => array(
        'invokables' => array(
			...
			'CacheController' => 'Admin\Controller\CacheController',
			'PayConfigController' => 'Admin\Controller\PayConfigController',
			'CompanyJobController' => 'Admin\Controller\CompanyJobController',
			'NewsController' => 'Admin\Controller\NewsController',
			'NavigationController' => 'Admin\Controller\NavigationController',
			'OrderController' => 'Admin\Controller\OrderController',
			'SearchestController'=> 'Admin\Controller\SearchestController',
        ),
    ),
    'view_manager' => array(
                ...
                'child_routes'  => array(
					...
					'searchest' => array(
                        ...
                        'options' => array(
                            ...
                            'defaults' => array(
                                'module'     =>'admin',
                                'controller' => 'SearchestController',
                                'action'     => 'index',
                            ),
                        ),
                    ),
